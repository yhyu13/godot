...
static GDExtensionObjectPtr player_create_instance(void *p_class_userdata, GDExtensionBool p_notify_postinitialize) {
	...
	gdsl_string_name_new(&parent_name, "CharacterBody2D", false);
...
static void player_get_speed_call(void *p_method_userdata, GDExtensionClassInstancePtr p_instance, const GDExtensionConstVariantPtr *p_args, GDExtensionInt p_argument_count, GDExtensionVariantPtr r_return, GDExtensionCallError *r_error) {
	Player *self = (Player *)p_instance;
	GDExtensionVariantFromTypeConstructorFunc ctor = gdsl_get_variant_from_type_constructor(GDEXTENSION_VARIANT_TYPE_FLOAT);
	ctor((GDExtensionUninitializedVariantPtr)r_return, (GDExtensionTypePtr)&self->speed);
}
static void player_get_speed_ptr(void *p_method_userdata, GDExtensionClassInstancePtr p_instance, const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
	Player *self = (Player *)p_instance;
	*(double *)r_ret = self->speed;
}
static void player_set_speed_call(void *p_method_userdata, GDExtensionClassInstancePtr p_instance, const GDExtensionConstVariantPtr *p_args, GDExtensionInt p_argument_count, GDExtensionVariantPtr r_return, GDExtensionCallError *r_error) {
	Player *self = (Player *)p_instance;
	if (gdsl_variant_get_type((GDExtensionConstVariantPtr)p_args[0]) != GDEXTENSION_VARIANT_TYPE_FLOAT) {
		return;
	}
	GDExtensionTypeFromVariantConstructorFunc to_type = gdsl_get_variant_to_type_constructor(GDEXTENSION_VARIANT_TYPE_FLOAT);
	to_type((GDExtensionUninitializedTypePtr)&self->speed, (GDExtensionVariantPtr)p_args[0]);
}
static void player_set_speed_ptr(void *p_method_userdata, GDExtensionClassInstancePtr p_instance, const GDExtensionConstTypePtr *p_args, GDExtensionTypePtr r_ret) {
	Player *self = (Player *)p_instance;
	self->speed = *(double *)p_args[0];
}
...
static GDExtensionObjectPtr bullet_create_instance(void *p_class_userdata, GDExtensionBool p_notify_postinitialize) {
	gdsl_StringName parent_name;
	gdsl_string_name_new(&parent_name, "Area2D", false);
	GDExtensionObjectPtr object = gdsl_classdb_construct_object(&parent_name);

	Bullet *self = (Bullet *)gdsl_mem_alloc(sizeof(Bullet));
	bullet_constructor(self);
	self->object = object;

	gdsl_StringName class_name;
	gdsl_string_name_new(&class_name, "Bullet", false);
	gdsl_object_set_instance(object, &class_name, (GDExtensionClassInstancePtr)self);
	gdsl_object_set_instance_binding(object, gdsl_library, self, &gdsl_binding_callbacks);
	return object;
}

static void bullet_free_instance(void *p_class_userdata, GDExtensionClassInstancePtr p_instance) {
	if (p_instance == NULL) {
		return;
	}
	Bullet *self = (Bullet *)p_instance;
	bullet_destructor(self);
	gdsl_mem_free(self);
}

static GDExtensionClassInstancePtr bullet_recreate_instance(void *p_class_userdata, GDExtensionObjectPtr p_object) {
	Bullet *self = (Bullet *)gdsl_mem_alloc(sizeof(Bullet));
	bullet_constructor(self);
	self->object = p_object;
	gdsl_object_set_instance_binding(p_object, gdsl_library, self, &gdsl_binding_callbacks);
...
static void gdsl_initialize(void *p_userdata, GDExtensionInitializationLevel p_level) {
	...
	gdsl_string_name_new(&gdsl_signal_hit, "hit", true);
	{
		...
		{
			gdsl_StringName mn;
			gdsl_string_name_new(&mn, "get_speed", false);
			GDExtensionClassMethodInfo mi = { 0 };
			mi.name = (GDExtensionStringNamePtr)&mn;
			mi.call_func = player_get_speed_call;
			mi.ptrcall_func = player_get_speed_ptr;
			mi.method_flags = GDEXTENSION_METHOD_FLAG_NORMAL;
			mi.has_return_value = 1;
			GDExtensionPropertyInfo ri;
			gdsl_StringName rn;
			...
			gdsl_StringName rc;
			gdsl_string_name_new(&rc, "", false);
			ri.type = GDEXTENSION_VARIANT_TYPE_FLOAT;
			ri.name = (GDExtensionStringNamePtr)&rn;
			ri.class_name = (GDExtensionStringNamePtr)&rc;
			ri.hint = 0;
			ri.hint_string = (GDExtensionStringPtr)gdsl_empty_string;
		...
		{
			gdsl_StringName mn;
			gdsl_string_name_new(&mn, "set_speed", false);
			GDExtensionClassMethodInfo mi = { 0 };
			mi.name = (GDExtensionStringNamePtr)&mn;
			mi.call_func = player_set_speed_call;
			mi.ptrcall_func = player_set_speed_ptr;
			mi.method_flags = GDEXTENSION_METHOD_FLAG_NORMAL;
			mi.has_return_value = 0;
			GDExtensionPropertyInfo ai;
			gdsl_StringName an;
			...
			gdsl_StringName ac;
			gdsl_string_name_new(&ac, "", false);
			ai.type = GDEXTENSION_VARIANT_TYPE_FLOAT;
			ai.name = (GDExtensionStringNamePtr)&an;
			ai.class_name = (GDExtensionStringNamePtr)&ac;
			ai.hint = 0;
			ai.hint_string = (GDExtensionStringPtr)gdsl_empty_string;
		...
		{
			gdsl_StringName pn;
			gdsl_string_name_new(&pn, "speed", false);
			gdsl_StringName sn;
			gdsl_string_name_new(&sn, "set_speed", false);
			gdsl_StringName gn;
			gdsl_string_name_new(&gn, "get_speed", false);
			GDExtensionPropertyInfo pi;
			gdsl_StringName pc;
			gdsl_string_name_new(&pc, "", false);
			pi.type = GDEXTENSION_VARIANT_TYPE_FLOAT;
			pi.name = (GDExtensionStringNamePtr)&pn;
			pi.class_name = (GDExtensionStringNamePtr)&pc;
			pi.hint = 0;
			pi.hint_string = (GDExtensionStringPtr)gdsl_empty_string;
	...
	}
	{
		...
		GDExtensionClassCreationInfo6 class_info = { 0 };
		class_info.is_exposed = 1;
		class_info.create_instance_func = bullet_create_instance;
		class_info.free_instance_func = bullet_free_instance;
		class_info.recreate_instance_func = bullet_recreate_instance;
		gdsl_classdb_register_extension_class6(gdsl_library, &class_name, &parent_name, &class_info);
		{
			gdsl_StringName sig_name;
			gdsl_string_name_new(&sig_name, "hit", false);
...
static void gdsl_deinitialize(void *p_userdata, GDExtensionInitializationLevel p_level) {
	...
	}
	{
		...
		gdsl_string_name_new(&unreg_name, "Bullet", false);
